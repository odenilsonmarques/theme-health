                    ...
                    <div class="col-md-6 content">
                        ...
                        <p class="atributted text-center">
                            ...
                            <span class="post-date">
                                ...
                                <a href="<?php the_permalink(); ?>"><?php echo $comments_number ? "$comments_number Comentários" : 'Sem comentários'; ?></a>
                            </span>
                        </p>
                        <a href="<?php the_permalink(); ?>" class="content-post"><p><?php echo wp_trim_words(get_the_content(), 30, ' [...]'); ?></p></a>
                    </div>
                <?php endwhile; ?>
            <?php else : ?>
